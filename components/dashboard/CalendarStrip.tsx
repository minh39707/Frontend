...
import { CalendarDay } from '@/services/habit.service';
...
export default function CalendarStrip({ monthLabel, days }: Props) {
  return (
            ...
            <View
              ...
              <View
                ...
                {isEmpty ? (
                  ...
                  <Ionicons color={statusColor} name="checkmark" size={16} />
                ) : (
                  <Text variant="label" style={[styles.warningMark, { color: statusColor }]}>
                    !
                  </Text>
                )}
              </View>
