        ...
        <View style={styles.card}>
          ...
          <View style={styles.group}>
            ...
            <View style={styles.chipWrap}>
              {HOURS.map((value) => (<Pressable key={value} onPress={() => setHour(value)} style={({ pressed }) => [styles.chip, hour === value && styles.chipSelected, pressed && styles.chipPressed]}>
          ...
          <View style={styles.group}>
            ...
            <View style={styles.chipWrap}>
              {MINUTES.map((value) => (<Pressable key={value} onPress={() => setMinute(value)} style={({ pressed }) => [styles.chip, minute === value && styles.chipSelected, pressed && styles.chipPressed]}>
          ...
          <View style={styles.group}>
            ...
            <View style={styles.inlineWrap}>
              {MERIDIEMS.map((value) => (<Pressable key={value} onPress={() => setMeridiem(value)} style={({ pressed }) => [styles.segment, meridiem === value && styles.segmentSelected, pressed && styles.chipPressed]}>
          ...
          <View style={styles.actions}>
            <PrimaryButton label="Use this time" onPress={() => onConfirm(fromTimePickerParts(hour, minute, meridiem))}/>
