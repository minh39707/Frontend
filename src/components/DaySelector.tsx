...
import { SpecificDay } from '@/src/types/onboarding';

type Props = {
  selectedDays: SpecificDay[];
  onToggle: (day: SpecificDay) => void;
};

export default function DaySelector({ selectedDays, onToggle }: Props) {
  return (
