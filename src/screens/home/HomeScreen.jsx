...
export default function HomeScreen() {
    ...
    return (<ScreenContainer contentContainerStyle={styles.content}>
        ...
        <LinearGradient colors={['#307AF3', '#1E5ED8']} end={{ x: 1, y: 1 }} start={{ x: 0, y: 0 }} style={styles.hero}>
          ...
          <View style={styles.heroStats}>
            <View style={styles.heroStatCard}>
              <Text color="white" style={styles.heroStatLabel} variant="caption">
                HP
              </Text>
              <Text color="white" style={styles.heroStatValue} variant="subtitle">
                {hp}/100
              </Text>
            </View>
            <View style={styles.heroStatCard}>
      ...
      <Animated.View entering={FadeInDown.duration(470).delay(40)} style={styles.expCardWrap}>
        <Card style={styles.expCard}>
          ...
          <View style={styles.expTrack}>
            <View style={[styles.expFill, { width: `${Math.max(12, expProgress * 100)}%` }]}/>
          </View>
          <Text color="muted" variant="body">
      ...
      <Animated.View entering={FadeInDown.duration(520).delay(80)} style={styles.statsGrid}>
      ...
      <Animated.View entering={FadeInDown.duration(560).delay(110)} style={styles.sectionBlock}>
        <View style={styles.sectionHeader}>
      ...
      <Animated.View entering={FadeInDown.duration(600).delay(140)} style={styles.sectionBlock}>
        <View style={styles.sectionHeader}>
        ...
        <View style={styles.missionList}>
          {missionItems.map((mission) => (<Card key={mission.title} style={styles.missionCard}>
              <View style={[styles.missionIcon, mission.done && styles.missionIconDone]}>
                <Ionicons color={mission.done ? '#0F9F6E' : colors.primary} name={mission.icon} size={18}/>
              </View>
      ...
      <Animated.View entering={FadeInDown.duration(640).delay(170)} style={styles.sectionBlock}>
      ...
      <View style={styles.actions}>
        ...
        <SecondaryButton label="Start over" onPress={() => {
