    ...
    <ScreenContainer>
      ...
      <View style={styles.list}>
        {EDUCATION_ITEMS.map((item, index) => (
          <Animated.View entering={FadeInDown.duration(430).delay(index * 60)} key={item.title}>
            <Card style={styles.card}>
              <View style={styles.iconWrap}>
                <Ionicons color={colors.primary} name={item.icon as keyof typeof Ionicons.glyphMap} size={22} />
              </View>
